...
public final class APreparenPreambleEntry extends PPreambleEntry
{
    private PValOrSid _valOrSid_;
    private final LinkedList<PConcat> _concat_ = new LinkedList<PConcat>();

    public APreparenPreambleEntry()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APreparenPreambleEntry(
    ...
    {
        ((Analysis) sw).caseAPreparenPreambleEntry(this);
    }
