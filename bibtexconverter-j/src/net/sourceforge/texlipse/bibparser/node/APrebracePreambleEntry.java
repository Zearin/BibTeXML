...
public final class APrebracePreambleEntry extends PPreambleEntry
{
    private PValOrSid _valOrSid_;
    private final LinkedList<PConcat> _concat_ = new LinkedList<PConcat>();

    public APrebracePreambleEntry()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new APrebracePreambleEntry(
    ...
    {
        ((Analysis) sw).caseAPrebracePreambleEntry(this);
    }
