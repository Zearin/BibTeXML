 ...
 *             java.text.DateFormat.class.getMethod(&quot;parse&quot;,
 *                     new Class[] { String.class }), format);
 ...
 * </pre>
 * 
 * @version $Revision$ ($Date: 2010-12-13 22:36:11 +0100 (Mo, 13. Dez
 *          2010) $)
 * @author Moritz Ringler
 */
public class GeneralInputVerifier<T> extends InputVerifier implements
     ...
     * 
     * @param c
     *            the class that input will be interpreted as
     * @param min
     *            lower limit. null for none.
     * @param max
     *            upper limit. null for none.
     * @throws IllegalArgumentException
     *             if <code>c</code> does not have a
     *             public static <code>valueOf(String)</code> method or a
     *             public constructor with a single string argument.
     * @throws ClassCastException
     *             if <code>min</code> and <code>max</code> are
     *             neither <code>null</code> nor instances of <code>c</code>.
     */
    public GeneralInputVerifier(Class<T> c, Comparable<T> min, Comparable<T> max) {
        setInputClass(c);
        setUpperLimit(max);
        setLowerLimit(min);
    }
     ...
     * @throws IllegalArgumentException
     *             if <code>c</code> does not have a
     *             public static <code>valueOf(String)</code> method or a public
     *             constructor with
     *             a single String argument
     */
    public GeneralInputVerifier(Class<T> c) {
        setInputClass(c);
    }
     ...
     *            the class that input will be interpreted as
     * @param m
     *            a public static method that accepts a single
     *            string argument and whose return type can be assigned to
     *            <code>c</code>
     * @throws IllegalArgumentException
     *             if <code>method</code> is not a public static method that
     *             accepts a single
     *             string argument and has a return type of <code>c</code>
     */
    public GeneralInputVerifier(Class<T> c, Method m) {
        setInputClass(c, m);
    }
     ...
     *            the class that input will be interpreted as
     * @param m
     *            a method that accepts a single
     *            string argument and whose return type can be assigned to
     *            <code>c</code>
     * @param o
     *            the object to invoke the method on, or <code>null</code> if
     *            <code>m</code> is static
     * @throws IllegalArgumentException
     *             if <code>method</code> is not a public method of
     *             <code>o</code> that accepts a single
     *             string argument and has a return type of <code>c</code>
     */
    public GeneralInputVerifier(Class<T> c, Method m, Object o) {
        setInputClass(c, m, o);
    }
     ...
     *            the class that input will be interpreted as
     * @throws IllegalArgumentException
     *             if <code>c</code> does not have a public
     *             static <code>valueOf(String)</code> method that returns a
     *             value of <code>c</code> or a public constructor with a single
     *             string argument.
     */
    public void setInputClass(Class<T> c) {
        method = null;
        constructor = null;
        ...
        try {
            ...
            try {
                ...
                throw new IllegalArgumentException("Caused by "
                        + exc.toString());
            }
        }
    }
     ...
     *            the class that input will be interpreted as
     * @param m
     *            a static method that accepts a single
     *            string argument and whose return type can be assigned to
     *            <code>c</code>
     * @throws IllegalArgumentException
     *             if <code>method</code> is not a public static method that
     ...
     *             string argument and has a return type of <code>c</code>
     */
    public void setInputClass(Class<T> c, Method m) {
     ...
     *             string argument and has a return type of <code>c</code>
     */
    public void setInputClass(Class<T> c, Method m, Object o) {
        /* check return type */
        if (!c.isAssignableFrom(m.getReturnType())) {
            throw new IllegalArgumentException(c
                    + " is not assignable from the return type of " + m);
        }
        ...
        if (params.length != 1 || !params[0].equals(String.class)) {
            throw new IllegalArgumentException(m
                    + " does not have the correct parameter types.");
        }
        ...
        if (!Modifier.isPublic(modifiers)) {
            throw new IllegalArgumentException(m + " is not public.");
        }

        if (o == null) {
            /* check whether m is static */
            if (!Modifier.isStatic(modifiers)) {
                throw new IllegalArgumentException(m + " is not static.");
            }

        } else {
            /* check whether m can be invoked on o */
            if (!m.getDeclaringClass().isInstance(o)) {
                throw new IllegalArgumentException(m + " cannot be invoked on "
                        + o);
            }
        }
        myClass = c;
     ...
     *            upper limit. null for none.
     * @throws ClassCastException
     *             if <code>max</code> is neither <code>null</code> nor an
     *             instance of <code>getInputClass</code>.
     */
    public void setUpperLimit(Comparable<T> max) {
        if (max == null) {
            this.max = null;
        } else {
     ...
     */
    public Comparable<T> getUpperLimit() {
        return max;
    }
     ...
     *            lower limit. null for none.
     * @throws ClassCastException
     *             if <code>min</code> is neither <code>null</code> nor an
     *             instance of <code>getInputClass</code>.
     */
    ...
    /**
     * Explains why the last call to {@link #verify(String) verify} returned
     ...
     */
    public Comparable<T> getLowerLimit() {
        return min;
    }
    ...
    public boolean verify(String text) {
        ...
        try {
            T value;
            if (method == null) {
                value = constructor.newInstance(in);
            } else {
                Object val = method.invoke(obj, in);
                if (myClass.isInstance(val)) {
